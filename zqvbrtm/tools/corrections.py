...
TEXT_FIXES_READ = {
    ...
    'q0614': [('Root or trust', 'Root of trust')],
    'q0658': [('in an investigating when', 'in an investigation when')],
    'q0673': [('should the CSO implement', 'should the CISO implement')],
    'q0678': [('Acknowledgement and attestation', 'Acknowledgment and attestation')],
